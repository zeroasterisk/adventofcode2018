...
"q", "r", "s", "t", "u", "v", "w", "x", "y", "z"]
  ...
  ## Examples
      ...
      iex> Fuel.Helper.string_freq_count("abcdef")
      %{"a" => 1, "b" => 1, "c" => 1, "d" => 1, "e" => 1, "f" => 1}

      iex> Fuel.Helper.string_freq_count("bababc")
      %{"a" => 2, "b" => 3, "c" => 1}
  ...
  ## Examples
      ...
      iex> Fuel.Helper.map_value_member?(Fuel.Helper.string_freq_count("abcdef"), 2)
      false

      iex> Fuel.Helper.map_value_member?(Fuel.Helper.string_freq_count("bababc"), 2)
      true

      iex> Fuel.Helper.map_value_member?(Fuel.Helper.string_freq_count("bababc"), 3)
      true

      iex> Fuel.Helper.map_value_member?(Fuel.Helper.string_freq_count("bababc"), 4)
      false
  ...
  ## Examples
      ...
      iex> Fuel.Helper.grid(5) |> List.last()
      %{x: 4, y: 4}

      iex> Fuel.Helper.grid(5) |> List.first()
      %{x: 0, y: 0}

      iex> Fuel.Helper.grid(5, %{id: :custom}) |> List.last()
      %{id: :custom, x: 4, y: 4}
